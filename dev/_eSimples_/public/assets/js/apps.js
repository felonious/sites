 ...
 * Help on hover
 */
$("icon-question").popover({trigger: "hover"});

/**
 * Alert auto dismiss
 */
$('.alert').fadeIn(300).delay(2500).fadeOut(300);
...
$(function () {
  $('[data-method]').append(function () {
    ...
    .attr('onclick', 'if ( confirm("Voce tem certeza?") == true ) { $(this).find("form").submit(); } else { return false; }');
});
...
$("#search_button").click(function (e) {
  e.preventDefault();
  $('#tables').toggleClass('col-md-12 col-md-9');
  $("#search_form").toggleClass('hide show');
});
